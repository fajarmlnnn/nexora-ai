...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) => _buildTransitionPage(
        state: state,
        child: AuthPage(redirect: state.uri.queryParameters['redirect']),
      ),
    ),
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) => _buildTransitionPage(
        state: state,
        child: WalletDetailPage(walletId: state.pathParameters['walletId']!),
      ),
    ),
    GoRoute(
      ...
      pageBuilder: (context, state) => _buildTransitionPage(
        state: state,
        child: const FinancialOverviewRealtimePage(),
      ),
    ),
    GoRoute(
      path: '/profile',
