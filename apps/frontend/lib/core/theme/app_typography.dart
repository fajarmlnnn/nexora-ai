...
abstract final class AppTypography {
  ...
  static const TextStyle displayLarge = TextStyle(fontFamily: fontFamily, fontSize: 32, fontWeight: FontWeight.w700, letterSpacing: -0.8, height: 1.10, color: AppColors.textPrimary);
  static const TextStyle displaySmall = displayLarge;
  static const TextStyle heading1 = TextStyle(fontFamily: fontFamily, fontSize: 28, fontWeight: FontWeight.w700, letterSpacing: -0.6, height: 1.15, color: AppColors.textPrimary);
  static const TextStyle heading2 = TextStyle(fontFamily: fontFamily, fontSize: 22, fontWeight: FontWeight.w600, letterSpacing: -0.3, height: 1.25, color: AppColors.textPrimary);
  static const TextStyle heading3 = TextStyle(fontFamily: fontFamily, fontSize: 18, fontWeight: FontWeight.w600, letterSpacing: -0.2, height: 1.30, color: AppColors.textPrimary);
  ...
  // Financial scale.
  static const TextStyle heroAmount = TextStyle(fontFamily: fontFamily, fontSize: 32, fontWeight: FontWeight.w700, letterSpacing: -0.8, height: 1.10, color: AppColors.textPrimary, fontFeatures: tabularFigures);
  ...
  // Compatibility aliases used by existing screens during migration.
