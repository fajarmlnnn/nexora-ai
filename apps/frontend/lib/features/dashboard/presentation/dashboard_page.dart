    ...
    return PremiumScaffold(
      child: summaryAsync.when(
        ...
        error: (error, stackTrace) => Padding(
          ...
          child: EmptyStateCard(icon: LucideIcons.triangleAlert, title: 'Data belum tersedia', message: error.toString(), action: 'Coba Lagi'),
        ),
        data: (summary) => SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            AppSpacing.gapMD,
            PremiumEntrance(delay: const Duration(milliseconds: 50), child: BalanceCard(summary: summary, totalBalance: totalAssets, onTap: () => context.push('/financial-overview'))),
            AppSpacing.gapLG,
            PremiumEntrance(
              delay: const Duration(milliseconds: 150),
              child: insightAsync.when(
                loading: () => const ShimmerSkeleton(height: 150),
                error: (error, stackTrace) => EmptyStateCard(icon: LucideIcons.bot, title: 'Insight belum tersedia', message: error.toString(), action: 'Coba Lagi'),
                data: (insight) => AIInsightCard(insight: insight),
              ),
            ),
            AppSpacing.gapMD,
            const PremiumEntrance(delay: Duration(milliseconds: 200), child: QuickActions()),
            AppSpacing.gapMD,
            PremiumEntrance(
              delay: const Duration(milliseconds: 250),
              child: budgetAsync.when(
                loading: () => const ShimmerSkeleton(height: 230),
                error: (error, stackTrace) => EmptyStateCard(icon: LucideIcons.triangleAlert, title: 'Budget belum tersedia', message: error.toString(), action: 'Coba Lagi'),
            ...
            PremiumEntrance(
              ...
              child: transactionsAsync.when(
                ...
                error: (error, stackTrace) => EmptyStateCard(icon: LucideIcons.triangleAlert, title: 'Transaksi belum tersedia', message: error.toString(), action: 'Coba Lagi'),
...
class _DashboardSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SingleChildScrollView(
        ...
        child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 14),
          PremiumEntrance(delay: Duration(milliseconds: 250), child: ShimmerSkeleton(height: 230)),
          SizedBox(height: 14),
