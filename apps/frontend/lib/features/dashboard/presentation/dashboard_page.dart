          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    '$walletCount ${walletCount == 1 ? 'wallet' : 'wallets'} aktif',
        ...
        children: [
          Row(
            children: [
              ...
              _TinyPill(
                label: '${analytics.transactionCount} transaksi',
                color: AppColors.primaryLight,
              ),
            ],
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: AppTypography.heading4.copyWith(fontWeight: FontWeight.w800),
              ),
              const SizedBox(height: 6),
              Text(
                'Ada kendala saat mengambil data keuanganmu. Coba muat ulang.',
