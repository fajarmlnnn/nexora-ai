        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Jadikan utama'),
              onTap: () => Navigator.pop(context),
            ),
            ListTile(
              leading: const Icon(LucideIcons.eyeOff),
              title: const Text('Sembunyikan wallet'),
              onTap: () => Navigator.pop(context),
            ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    return PremiumCard(
      ...
      gradient: const LinearGradient(
        ...
        colors: [Color(0xFF171525), Color(0xFF11111A), Color(0xFF0C0D13)],
      ),
      child: Column(
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Saldo tersedia', style: AppTypography.bodySmall),
                    const SizedBox(height: 3),
                    FittedBox(
                      fit: BoxFit.scaleDown,
                      alignment: Alignment.centerLeft,
                      child: Text(
                        visible ? rupiah(wallet.balance) : 'Rp •••••••••',
...
class _AiCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String advice;
    if (wallet.balance <= 0) {
      advice = 'Saldo wallet ini kosong. Isi hanya jika memang punya fungsi yang jelas.';
    } else if (wallet.isPrimary) {
      advice = 'Wallet utama sebaiknya fokus pada dana operasional. Pisahkan dana tujuan agar arus kas lebih mudah dikontrol.';
    } else {
      advice = 'Wallet ini bisa menjadi kantong khusus agar distribusi aset lebih mudah dipantau.';
    }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF0B0A12), Color(0xFF24133E)],
        ),
        borderRadius: AppRadius.radiusXXL,
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(LucideIcons.sparkles, color: AppColors.primaryLight, size: 19),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(advice, style: AppTypography.caption.copyWith(height: 1.45)),
              ],
            ),
          ),
        ],
      ...
      child: Column(
        children: [
          ListTile(
            ...
            title: const Text('Edit wallet'),
            subtitle: const Text('Ubah nama dan detail wallet'),
            onTap: () {},
          ),
          ListTile(
            leading: const Icon(LucideIcons.trash2, size: 19, color: AppColors.danger),
            title: const Text('Hapus wallet'),
            subtitle: const Text('Riwayat transaksi tidak ikut dihapus'),
  ...
  Future<void> _confirmDelete(BuildContext context, WidgetRef ref) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text('Hapus wallet?'),
        content: const Text('Wallet akan dihapus dari daftar.'),
        actions: [
          TextButton(
