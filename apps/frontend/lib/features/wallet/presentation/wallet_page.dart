  ...
  Widget build(BuildContext context) {
    ...
    return PremiumScaffold(
      child: walletsAsync.when(
        ...
        data: (_) {
          if (wallets.isEmpty) {
            return _EmptyWallet(onAdd: _addWallet);
          }
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              padding: AppSpacing.screen.copyWith(
                bottom: AppSpacing.bottomNav(context) + 18,
              ),
              children: [
    ...
    return PremiumCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Gabungan saldo wallet yang terlihat',
...
class _WalletTile extends StatelessWidget {
  ...
  double get percentage => totalBalance <= 0 || wallet.balance <= 0
      ? 0
      : (wallet.balance / totalBalance) * 100;
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(wallet.icon, color: accentColor, size: 21),
              ),
    ...
    return ListView(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            'Tambahkan rekening bank, e-wallet, uang tunai, atau investasi untuk mulai mengelola asetmu.',
            textAlign: TextAlign.center,
