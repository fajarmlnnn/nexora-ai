          ...
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: const Center(
                  child: Icon(LucideIcons.plus, color: AppColors.primaryLight, size: 20),
                ),
              ),
            ),
          ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: _StaticAmount(
                    text: visible ? rupiah(balance) : 'Rp •••••••••',
  ...
  Widget build(BuildContext context) {
    ...
    return PremiumCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          PremiumIconBadge(icon: walletTypeIcon(type), color: AppColors.primary, size: 31),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 2),
                  Text(
                    'Pengeluaran makan & minummu naik 18% dibanding bulan lalu. Saatnya atur budget!',
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: AppTypography.caption.copyWith(
